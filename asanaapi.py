...
class AsanaApi(object):
    ...
    def get_workspaces_tasks(self, workspace_id, assignee='me', completed_since=None,
            completed=None, follower=None, project_id=None, modified_since=None):
        params = {}
        ...
        params.update({'opt_fields': "name,completed,tags.name,completed_at,workspace.name,parent.name,parent.workspace,followers,assignee.name, modified_at, projects.name"})
